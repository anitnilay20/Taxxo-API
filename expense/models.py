...
class Expense(models.Model):
    ...
    firstAccount = models.ForeignKey(Ledgers, related_name="expenseFirstAccount")
    secondAccount = models.ForeignKey(Ledgers, related_name="expenseSecondAccount")
    ...
    def save(self, *args, **kwrgs):
        ...
        activity = Activity(name="Expense",date=self.date,added_by_id=self.addedBy_id,amount=self.amount,company=self.company)
        activity.save()
